        ...
        <header className="header">
            <div className="header__container">
                ...
                <div className="header__options">
                    <Link className='header__svgBtn' to="/" style={{height: '24px'}}>
                        <svg aria-label="Inicio" className="_8-yf5 " color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                    ...
                    <svg className='header__svgBtn' aria-label="Messenger" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                    ...
                    <AddPost />
                    <svg className='header__svgBtn' aria-label="Buscar personas" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                    ...
                    <svg className='header__svgBtn' aria-label="Feed de actividad" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
